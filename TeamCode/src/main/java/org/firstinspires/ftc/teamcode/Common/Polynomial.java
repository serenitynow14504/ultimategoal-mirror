...
public class Polynomial {
    ...
    public Polynomial(VectorD start, double dStart, double d2Start, VectorD end, double dEnd, double d2End) throws IllegalArgumentException{
    ...
    public Polynomial(double sX, double eX, double a, double b, double c, double d, double e, double f) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
