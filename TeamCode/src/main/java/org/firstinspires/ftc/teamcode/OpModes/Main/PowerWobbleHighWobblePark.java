...
@Autonomous(name="PowerWobbleHighWobblePark", group="_MAIN")
@Disabled
public class PowerWobbleHighWobblePark extends LinearOpMode {
    Robot robot;
    ...
    public void runOpMode() {
        ...
        sleep(250);
        robot.shooter.autoPowerShot();
        robot.followPath2D(path, 0.3);
        ...
        robot.posOnRobotToGlobalPos(RobotConstants.GRABBER_POS, target, 0.75, -3);
        sleep(150);
        robot.wobbleArm.release();
