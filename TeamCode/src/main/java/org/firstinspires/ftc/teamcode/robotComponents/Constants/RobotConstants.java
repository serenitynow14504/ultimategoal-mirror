...
public abstract class RobotConstants {
    ...
    public static final double DRIVE_GEAR_RATIO = 2.0;
    public static final double WHEEL_DIAMETER_INCHES = 100 / 25.4;


    public static final double CENTER_TO_WHEEL_DIST = 6.25;

    public static final float width = 18;//12.9f;
    public static final float length = 18;

    public static final double TRACK_WIDTH = 6.25; //opposing
    public static final double WHEELBASE = 4.5; //adjacent


    //=================================ODOMETRY ENCODERS===========================================
    public static final double ODO_ENCODER_COUNTS_PER_REV = 8192;//8192
    ...
    public static final VectorD FRONT_LEFT_ODO_POSE = new VectorD(-calculatedDist/2, 0, 0);//-calculatedDist /2, -1.5, 0
    public static final String FRONT_LEFT_ODO_NAME = "fLeft";

    public static final VectorD FRONT_RIGHT_ODO_POSE = new VectorD(calculatedDist/2, 0, 0);//calculatedDist /2, -1.5, 0
    public static final String FRONT_RIGHT_ODO_NAME = "fLeft";

    public static final VectorD SIDE_ODO_POSE = new VectorD(-1.8125, -3.5, Math.PI/2);//-1.8125, -5, Math.PI/2
    public static final String SIDE_ODO_NAME = "fLeft";
    //=============================================================================================
