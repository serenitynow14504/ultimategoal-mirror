...
public class PurePursuitController2D extends MovementController{
    ...
    public void followPath(double power) {
        ...
        do {
            ...
            VectorF globalFollowVector = path.pointFromParameter(lookAhead);
            ...
            VectorF obstacleRepel = robot.getEnvironmentRepulsionVectorFromCenter();
            ...
            VectorF finalGlobalVector = globalFollowVector.added(returnToPath).added(obstacleRepel);
