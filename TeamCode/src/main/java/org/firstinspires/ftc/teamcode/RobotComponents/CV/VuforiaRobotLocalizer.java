...
public class VuforiaRobotLocalizer {
    ...
    private static final float mmTargetHeight   = (6) * mmPerInch;          // the height of the
    // center of the target image above the floor
    ...
    public void init(HardwareMap hardwareMap) {
        ...
        final float CAMERA_FORWARD_DISPLACEMENT  = 9.0f * mmPerInch;   // eg: Camera is 4 Inches
        // in front of robot-center
        final float CAMERA_VERTICAL_DISPLACEMENT = 6.5f * mmPerInch;   // eg: Camera is 8 Inches
        // above ground
    ...
    public VectorD getPose() throws Exception {
